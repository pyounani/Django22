...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.user_you = User.objects.create_user(username="you", password="password")
    ...
    def test_post_detail(self):
        ...
        self.assertIn(post_001.title, soup.title.text)  #앞서서 post-area을 보겠다는 것이고 이것은 전체적인 title에 포함이 되어져있는가를 확인하는 것
